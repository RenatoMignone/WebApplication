...
// The role of this file is to define the structure of the objects that will be used inside the application.
// The objects are defined using the constructor function.
// For the question object we have defined some methods of the class
...
function Question(id, text, questioner, date) {
    ...
    // function defined to retrieve the answers to a question
    this.getAnswers = () => {
        return [...this.answers];
      }
