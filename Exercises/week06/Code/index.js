...
const { check, validationResult } = require('express-validator'); // Middleware for validating and sanitizing inputs
const validator = require('validator'); // Library for string validation and sanitization

// Importing Content Security Policy (CSP) header configuration
const { expressCspHeader, INLINE, NONE, SELF } = require('express-csp-header');

// Setting up DOMPurify for sanitizing HTML
const createDOMPurify = require('dompurify'); // Library for sanitizing HTML
const { JSDOM } = require('jsdom'); // JSDOM for creating a virtual DOM
const window = new JSDOM('').window; // Creating a virtual DOM window
const DOMPurify = createDOMPurify(window); // Initializing DOMPurify with the virtual DOM

// Importing the Data Access Object (DAO) module for database operations
const dao = require('./dao'); // Use ./ syntax for files in the same directory
